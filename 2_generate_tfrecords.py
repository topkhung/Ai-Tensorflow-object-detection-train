...
TRAIN_IMAGES_DIR = os.getcwd() + "/dataset/resize/"
...
def classAsTextToClassAsInt(classAsText):
    ...
    if classAsText == '005-21':
        return 1
    elif classAsText == 'CP871-14':
        return 1
    elif classAsText == '005-18J':
        return 1
    elif classAsText == '982J':
        return 1
    elif classAsText == 'Beef2':
        return 1
    elif classAsText == '970J':
        return 1
    else:
